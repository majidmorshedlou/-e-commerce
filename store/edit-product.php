...
<div id="main">
    ...
    <form action="edit-product.php?edit-product-id=<?php echo $product['id'] ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="content">
            ...
            <input type="text" name="product-name" placeholder="نام محصول" required  value="<?php echo $product['product_name'] ?>"><br>
            <input type="text" name="product-price" placeholder="قیمت محصول" required value="<?php echo $product['product_price'] ?>"><br>
            <input type="text" name="product-count" placeholder="تعداد" required value="<?php echo $product['product_count'] ?>"><br>
            <input type="text" name="product-seller" placeholder="فروشنده" required value="<?php echo $product['product_seller'] ?>"><br>
            <input type="text" name="product-color" placeholder="رنگ محصول" value="<?php echo $product['product_color'] ?>"><br>
